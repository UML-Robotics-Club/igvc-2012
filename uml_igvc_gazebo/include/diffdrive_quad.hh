 ...
 * Adapted to four wheels by Nat Tuck.
 */
#ifndef DIFFDRIVE_QUAD_HH
#define DIFFDRIVE_QUAD_HH
...
class DiffDriveQuad : public Controller
{

public:
  DiffDriveQuad(Entity *parent);
  virtual ~DiffDriveQuad();
...
private:
  ...
  ParamT<std::string> *leftRearJointNameP;
  ParamT<std::string> *rightRearJointNameP;
